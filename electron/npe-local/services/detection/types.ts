/**
 * AI Detection Type Definitions
 *
 * Types for the local AI detection system based on empirical research:
 * - Burstiness (sentence length variance)
 * - Semicolon frequency
 * - Em/en-dash patterns
 * - Tell-phrase matching
 */
...
export const DETECTOR_VERSION = '2.1.0-local';

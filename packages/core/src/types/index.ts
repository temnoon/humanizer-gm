 ...
 *
 * Unified Book System (Dec 2025):
 * - Entity: URI-based reference system
 * - Profile: Persona, Style, BookProfile
 * - Passage: Source passages and threads
 * - Pyramid: Hierarchical summarization
 * - Thinking: Curator context and decisions
 * - Book: Unified book project types
 */
...
// Entity base types (URI system)
export * from './entity.js';

// Profile types (Persona, Style, BookProfile)
export * from './profile.js';

// Passage types (SourcePassage, BookThread)
export * from './passage.js';

// Pyramid types (hierarchical summarization)
export * from './pyramid.js';

// Thinking types (curator context, decisions)
